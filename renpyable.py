...
class Renpyable:
    ...
    def delete_old_ppf_files(self):
        ...
        for f in ppf_file_list:
            ...
            try:
                ...
                delete_treshold_date = datetime.date(today_date.year,
                                                     today_date.month - 1,
                                                     today_date.day)
            except:
    ...
    def correct_pdf_filenames(self, digits):
        """
            ...
            Corects pdf chunk files from clients,
...
if __name__ == "__main__":
    ...
    while answer < 7:
        ...
        print(
            "This programm let you change name of TIF files generated by Trueflow.\nChoose what do you want to do:\n")
        print(
            "1. Correct File names i.e. 1 = 1, 2 = 02, 3 = 003 | AFRONT instead FRONT etc.")
